...
class Atom
{
    ...
    public function __construct($rootDir, $config)
    {
        ...
        self::$app = $this;
        $this->log = new T4LOG(["logRootDir" => array_key_exists("logPath", $config) ? $config["logPath"] : self::$ROOT_DIR . DIRECTORY_SEPARATOR . "runtime" . DIRECTORY_SEPARATOR . "log" . DIRECTORY_SEPARATOR]); // temporary
