...
final class a0001_initial {
    public function up()
    {
        ...
        $SQL = "CREATE TABLE `{{prefix}}users` (
            ...
            `user_uuid` binary(16) NOT NULL COMMENT 'UUID_TO_BIN(UUID())',
            ...
            `account_type_id` smallint UNSIGNED NOT NULL COMMENT 'id from allowed_values table',
            `role_id` smallint UNSIGNED NOT NULL COMMENT 'role_id id from allowed_values table',
            `status_id` smallint UNSIGNED NOT NULL COMMENT 'All statuses are kept, such as pending verification (which is waiting for email confirmation), whether the user is banned, etc.\r\nid from allowed_values table',
