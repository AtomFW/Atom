...
final class a0002_initial_servers {
    public function up()
    {
        ...
        $SQL = "CREATE TABLE `{{prefix}}servers` (
            ...
            `provider_id` smallint UNSIGNED NOT NULL DEFAULT '120' COMMENT 'self_hosted, ovh, google, aws, azure, jbm, oracle... | id from allowed_values',
            `is_active` tinyint UNSIGNED NOT NULL DEFAULT '1' COMMENT '1 = active, 0 = inactive',
            `environment_id` smallint UNSIGNED NOT NULL DEFAULT '0' COMMENT '''production'',''staging'',''development'',''testing'', 0 = debug | id from allowed_values',
            `main_service_type_id` smallint UNSIGNED NOT NULL DEFAULT '120' COMMENT 'php-fpm, nginx, mysql, redis, backup, etc. | id from allowed_values',
            `server_role_id` smallint UNSIGNED NOT NULL DEFAULT '0' COMMENT '''primary'',''secondary'',''backup'',''worker'',''storage'',''monitoring'',''cdn_edge'',''backup_only'',''database_only'', 0 = primary | id from allowed_values',
            ...
            `type_id` smallint UNSIGNED NOT NULL DEFAULT '0' COMMENT 'dedicated, vps, container, other, 0 = dedicated | id from allowed_values',
