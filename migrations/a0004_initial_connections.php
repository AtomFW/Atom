...
final class a0004_initial_connections {
    ...
    public function up()
    {
        ...
        $SQL = "CREATE TABLE `{{prefix}}connections` (
            ...
            `area_code` mediumint DEFAULT NULL COMMENT 'area code connection',
            `dma_code` mediumint DEFAULT NULL COMMENT 'region code',
            `region` mediumint NOT NULL COMMENT 'id region',
